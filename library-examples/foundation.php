...
function basetheme_menu_fallback()
{
    ...
    printf(
        __('Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'basetheme'),
        /* translators: %s: menu url */
        sprintf(
            __('<a href="%s">Menus</a>', 'basetheme'),
            get_admin_url(get_current_blog_id(), 'nav-menus.php')
        ),
        /* translators: %s: customize url */
        sprintf(
            __('<a href="%s">Customize</a>', 'basetheme'),
