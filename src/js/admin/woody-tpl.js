...
$('#post').each(function () {
    ...
    if (accepted_post.includes($('#post_type').val()) || $("[data-name=menu_items]").length) {
        ...
        var getFilters = function (group) {
            ...
            if (group == 'group_5b0d1ed32a384' || group == 'group_5b2788b48d04c' || group == 'group_5d7908eadaa46' || group == 'group_5b33890e6fa0b' || group == 'field_5d16118093cc1' || group == 'group_shared_leaflets') {
