...
class WoodyTheme_Enqueue_Assets
{
    ...
    public function enqueueLibraries()
    {
        ...
        if (!$this->isTouristicSheet || defined('IS_WOODY_HAWWWAI_SHEET_ENABLE')) {
            wp_enqueue_script('jsdelivr_swiper', get_template_directory_uri() . '/src/lib/custom/swiper@4.4.1.min.js', [], null); // TODO: Latest 4.5.2
        }
        ...
        wp_enqueue_script('jsdelivr_plyr', get_template_directory_uri() . '/src/lib/custom/plyr@3.6.8.min.js', [], null); // TODO: Latest 3.7.7
