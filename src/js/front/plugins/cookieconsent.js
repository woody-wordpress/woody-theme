...
if (window.globals.current_lang.indexOf('fr') != -1 || window.globals.current_lang.indexOf('br') != -1) {
...
} else if (window.globals.current_lang.indexOf('de') != -1) {
...
} else if (window.globals.current_lang.indexOf('nl') != -1) {
...
} else if (window.globals.current_lang.indexOf('es') != -1) {
...
} else if (window.globals.current_lang.indexOf('it') != -1) {
...
} else if (window.globals.current_lang.indexOf('ja') != -1) {
    ...
    var link = 'もっと知りたい';
    var policy = 'クッキーポリシー';
} else if (window.globals.current_lang.indexOf('zh') != -1) {
...
} else if (window.globals.current_lang.indexOf('ru') != -1) {
...
var enableAnalytics = function () {
    ...
    if (!window.enableAnalyticsEvent) {
        ...
        window.dataLayer.push({
            event: 'analytics_enable_' + window.globals.current_lang
        });
    }
};
...
var disableAnalytics = function () {
    ...
    window.dataLayer.push({
        event: 'analytics_disable_' + window.globals.current_lang
    });
};
...
var enableCookies = function () {
    ...
    if (!window.enableCookiesEvent) {
        ...
        window.dataLayer.push({
            event: 'cookies_enable_' + window.globals.current_lang
        });
    }
};
...
var disableCookies = function () {
    ...
    window.dataLayer.push({
        event: 'cookies_disable_' + window.globals.current_lang
    });
};
