...
if ( ! class_exists( 'Basetheme_Protocol_Relative_Theme_Assets' ) ) :
	class Basetheme_Protocol_Relative_Theme_Assets {
		/**
	...
	$foundationpress_protocol_relative_theme_assets = new Basetheme_Protocol_Relative_Theme_Assets;
endif;
